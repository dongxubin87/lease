package com.dong.lease.common.result;
...
public enum ResultCodeEnum {
    ...
    DELETE_ERROR(207, "Please delete child records first"),
    ...
    ADMIN_APARTMENT_DELETE_ERROR(310, "Please delete roominfo first"),
    ...
    APP_SEND_SMS_TOO_OFTEN(504, "SMS sent too frequently"),
